...
#' @note The user may want to use \code{\link[textcleanLite]{replace_ordinal}} first to
#' remove ordinal number notation.  For example \code{\link[textcleanLite]{replace_number}}
#' would turn "21st" into "twenty onest", whereas \code{\link[textcleanLite]{replace_ordinal}}
